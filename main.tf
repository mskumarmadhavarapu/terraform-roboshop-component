...
resource "aws_ec2_instance_state" "main" {
  instance_id = aws_instance.main.id # Replace with your instance ID
  state   = "stopped"
...
resource "aws_launch_template" "main" {
  ...
  # once autoscalling sees less traffic, it will terminate the instance
  ...
  # tags for instances created by launch template through autoscalling
  tag_specifications {
